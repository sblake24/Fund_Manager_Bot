...
function renderPsb(){
  ...
  var html='<div class="card"><table>'+
    '<thead><tr><th>Username</th><th>Password</th><th>Link</th><th>Notes</th><th>Status</th><th></th></tr></thead>'+
...
async function togglePsbStatus(id, status){
  await sb.from('psb_accounts').update({status:status}).eq('id',id);
...
async function savePsbAccount(){
  var obj={username:document.getElementById('psb-user').value.trim(),password:document.getElementById('psb-pw').value.trim(),link:document.getElementById('psb-link').value.trim(),notes:document.getElementById('psb-notes').value.trim(),status:getPsbStatus('add')};
...
async function updatePsbAccount(){
  var obj={username:document.getElementById('epsb-user').value.trim(),password:document.getElementById('epsb-pw').value.trim(),link:document.getElementById('epsb-link').value.trim(),notes:document.getElementById('epsb-notes').value.trim(),status:getPsbStatus('edit')};
